 ...
 * @author estudiante
 */
public class RadioB extends javax.swing.JDialog {

    /**
     * Creates new form RadioB
     */
    public RadioB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        etiResultado.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                RadioB dialog = new RadioB(new javax.swing.JFrame(), true);
